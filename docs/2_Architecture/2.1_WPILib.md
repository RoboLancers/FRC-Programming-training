...
These include the [Phoenix library](https://v6.docs.ctr-electronics.com/en/stable/) made by CTRE, and [RevLib](https://docs.revrobotics.com/revlib) the manufacturers of the majority of our motor controllers.
...
Another is [PathPlanner](https://pathplanner.dev/home.html), a library to follow paths generated in a standalone app for the Autonomous portion of a match.
...
- Read through [WPILib's zero to robot programming guide](https://docs.wpilib.org/en/stable/docs/zero-to-robot/step-4/creating-test-drivetrain-program-cpp-java.html)
  ...
  - 427 mostly uses Rev components (321 uses CTRE), so select the appropriate tab for the example code.
