...
- Join Robolancers Robotics Github organization by asking Armond or Carl to add your Github account
- Simple commit
...
- **ALWAYS ALWAYS ALWAYS** commit before you leave a meeting, especially if you are using a computer that is not yours!
