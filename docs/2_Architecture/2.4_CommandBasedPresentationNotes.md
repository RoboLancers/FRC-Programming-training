---
title: Command Based Presentation Notes
layout: default
nav_order: 8
---

[Previous: Command Based Programming](2.3_CommandBased.md) | [Next: Kitbot Intro](2.5_KitbotIntro.md)
...
### So we made a Command, now what? We Bind it
...
- Anonymous Functions are functions without a name that are used once and then discarded.
- The ```() ->``` syntax is used to declare anonymous functions.

In the example below, anonymous functions are used to create the function inputs required by the RollerCommand class.
